#line 1 "modbus\\MBport\\porttimer.c"
...
#line 24 "modbus\\MBport\\porttimer.c"
...
#line 27 "modbus\\MBport\\porttimer.c"
#line 28 "modbus\\MBport\\porttimer.c"
...
{
	DrvTIMER_Init();
	DrvTIMER_Open(E_TMR1,8000/usTim1Timerout50us,E_ONESHOT_MODE);
	TMR1_EnableInt(Timer1CallBack);					
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))->TCSR.CEN = 0;
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))->TDR = 0;								
