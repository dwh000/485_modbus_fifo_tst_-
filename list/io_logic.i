...
void GPIOInit(void)
{
	...
	(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*0)) + (0x4*10)))) = 0;
	(*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*0)) + (0x4*11)))) = 0;
}

u32bit GetUart1Baud(void)
{
	u32bit Addr = 0;
	Addr = (*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*2))));
	Addr = (Addr<<1) + (*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*1))));
	Addr = (Addr<<1) + (*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*2)) + (0x4*0))));
	switch (Addr){
	case 1:
		return 9600;
	case 2:
