#line 1 "modbus\\functions\\mbutils.c"
...
#line 33 "modbus\\functions\\mbutils.c"
...
#line 34 "modbus\\functions\\mbutils.c"
...
#line 37 "modbus\\functions\\mbutils.c"
...
#line 40 "modbus\\functions\\mbutils.c"
#line 41 "modbus\\functions\\mbutils.c"
                ...
                UCHAR ucValue )
{
    ...
    ((ucNBits <= 8) ? (void)0 :  __aeabi_assert("ucNBits <= 8", "modbus\\functions\\mbutils.c", 56), (__promise)((ucNBits <= 8)?1:0));
    ((( size_t )8U == sizeof( UCHAR ) * 8) ? (void)0 :  __aeabi_assert("( size_t )BITS_UCHAR == sizeof( UCHAR ) * 8", "modbus\\functions\\mbutils.c", 57), (__promise)((( size_t )8U == sizeof( UCHAR ) * 8)?1:0));
