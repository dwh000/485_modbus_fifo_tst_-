#line 1 "modbus\\MBport\\portserial.c"
...
#line 3 "modbus\\MBport\\portserial.c"
...
#line 7 "modbus\\MBport\\portserial.c"
#line 8 "modbus\\MBport\\portserial.c"
...
{
	if(xRxEnable){
		((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->IER.RDA_IEN = 1;
	}
	else{
		((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->IER.RDA_IEN = 0;
	}
	if(xTxEnable){
		((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->IER.THRE_IEN = 1;
		prvvUARTTxReadyISR();
	}
	else{
		((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->IER.THRE_IEN = 0;
	}
}
...
xMBPortSerialInit( UCHAR ucPORT, ULONG ulBaudRate, UCHAR ucDataBits, eMBParity eParity )
{
	...
	Uart0Param.u32BaudRate = ulBaudRate;					
	switch(eParity){										
		case MB_PAR_EVEN:										
			Uart0Param.u8cDataBits		= DRVUART_DATABITS_8;	
			Uart0Param.u8cStopBits		= DRVUART_STOPBITS_1;	
			Uart0Param.u8cParity 		= DRVUART_PARITY_EVEN;	
			break;
		case MB_PAR_ODD:										
			Uart0Param.u8cDataBits		= DRVUART_DATABITS_8;	
			Uart0Param.u8cStopBits		= DRVUART_STOPBITS_1;	
			Uart0Param.u8cParity 		= DRVUART_PARITY_ODD;	
			break;
		case MB_PAR_NONE:										
			Uart0Param.u8cDataBits		= DRVUART_DATABITS_8;	
			Uart0Param.u8cStopBits		= DRVUART_STOPBITS_2;	
			Uart0Param.u8cParity 		= DRVUART_PARITY_NONE;	
			break;
		default:												
			Uart0Param.u8cDataBits		= DRVUART_DATABITS_8;	
			Uart0Param.u8cStopBits		= DRVUART_STOPBITS_1;	
	...
	Uart0Param.u8cRxTriggerLevel= DRVUART_FIFO_1BYTES;		
	Uart0Param.u8TimeOut = 0x7f;							
	if(bInitialized){										
		DrvUART_Open(UART_PORT0, &Uart0Param);
		((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->MCR.LEV_RTS = 0;
		RS485FnPara.u8cAddrEnable = 0;
		RS485FnPara.u8cAddrValue = 0;
		RS485FnPara.u8cDelayTime = 2;
		RS485FnPara.u8cModeSelect = MODE_RS485_AUD;			
...
{
	((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->DATA = ucByte;
	return 1;
}
...
{
	*pucByte = ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->DATA;
	return 1;
}
...
{   
	if(((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->ISR.RLS_INT){								
		if(((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FSR.BIF)	((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FSR.BIF = 1;
		if(((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FSR.FEF)	((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FSR.FEF = 1;
		if(((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FSR.PEF)	((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FSR.PEF = 1;
	}
	if((((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->ISR.RDA_INT) | (((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->ISR.TOUT_INT)){
		prvvUARTRxISR();
	}
	if(((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->ISR.THRE_INT){
		prvvUARTTxReadyISR();
	}
...
{
	while (((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FSR.TE_FLAG !=1);
