...
#line 40 "modbus\\rtu\\mbrtu.c"
#line 1 "modbus\\rtu\\mbrtu.h"
...
#line 41 "modbus\\rtu\\mbrtu.c"
#line 1 ".\\modbus\\include\\mbframe.h"
...
#line 42 "modbus\\rtu\\mbrtu.c"

#line 1 "modbus\\rtu\\mbcrc.h"
...
#line 44 "modbus\\rtu\\mbrtu.c"
#line 45 "modbus\\rtu\\mbrtu.c"
...
eMBRTUReceive( UCHAR * pucRcvAddress, UCHAR ** pucFrame, USHORT * pusLength )
{
    ...
    EnterCriticalSection( );
    ((usRcvBufferPos < 256) ? (void)0 :  __aeabi_assert("usRcvBufferPos < MB_SER_PDU_SIZE_MAX", "modbus\\rtu\\mbrtu.c", 157), (__promise)((usRcvBufferPos < 256)?1:0));
...
xMBRTUReceiveFSM( void )
{
    ...
    ((eSndState == STATE_TX_IDLE) ? (void)0 :  __aeabi_assert("eSndState == STATE_TX_IDLE", "modbus\\rtu\\mbrtu.c", 231), (__promise)((eSndState == STATE_TX_IDLE)?1:0));
...
xMBRTUTransmitFSM( void )
{
    ...
    ((eRcvState == STATE_RX_IDLE) ? (void)0 :  __aeabi_assert("eRcvState == STATE_RX_IDLE", "modbus\\rtu\\mbrtu.c", 290), (__promise)((eRcvState == STATE_RX_IDLE)?1:0));
...
xMBRTUTimerT35Expired( void )
{
    ...
    default:
        ((( eRcvState == STATE_RX_INIT ) || ( eRcvState == STATE_RX_RCV ) || ( eRcvState == STATE_RX_ERROR )) ? (void)0 :  __aeabi_assert("( eRcvState == STATE_RX_INIT ) || ( eRcvState == STATE_RX_RCV ) || ( eRcvState == STATE_RX_ERROR )", "modbus\\rtu\\mbrtu.c", 347), (__promise)((( eRcvState == STATE_RX_INIT ) || ( eRcvState == STATE_RX_RCV ) || ( eRcvState == STATE_RX_ERROR ))?1:0));
